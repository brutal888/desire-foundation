...
<div className="text-2xl font-['Noto_Serif'] font-bold text-[#181e00]">Desire Foundation</div>
...
<div className="font-['Noto_Serif'] text-xl text-[#181e00] font-bold">Desire Foundation</div>
